    ...
    public function run(): void
    {
        ...
        foreach ($dataset as $data) {
            ...
            if ($nilaiAngka >= 80) {
                ...
                $data['nilaiHuruf'] = 'A-';
                $data['bobotKualitas'] = 3.70 + ($nilaiAngka - 77) * 0.1;
            } elseif ($nilaiAngka >= 74) {
                $data['nilaiHuruf'] = 'B+';
                $data['bobotKualitas'] = 3.40 + ($nilaiAngka - 74) * 0.1;
            } elseif ($nilaiAngka >= 70) {
                $data['nilaiHuruf'] = 'B';
                $data['bobotKualitas'] = 3.00 + ($nilaiAngka - 70) * 0.1;
            } elseif ($nilaiAngka >= 65) {
                $data['nilaiHuruf'] = 'B-';
                $data['bobotKualitas'] = 2.64 + ($nilaiAngka - 65) * 0.072;
            } elseif ($nilaiAngka >= 61) {
                $data['nilaiHuruf'] = 'C+';
                $data['bobotKualitas'] = 2.35 + ($nilaiAngka - 61) * 0.0725;
            } elseif ($nilaiAngka >= 56) {
                $data['nilaiHuruf'] = 'C';
                $data['bobotKualitas'] = 2.00 + ($nilaiAngka - 56) * 0.07;
            } elseif ($nilaiAngka >= 45) {
                $data['nilaiHuruf'] = 'D';
                $data['bobotKualitas'] = 1.00 + ($nilaiAngka - 45) * 0.090909;
            } else {
                $data['nilaiHuruf'] = 'E';
