...
<head>
    ...
    <title>Buat Data Histori Nilai Baru</title>
        ...
        <div class="form-card">
            <form method= "POST" action="{{ route('historiNilai.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="bobot" step="0.01" min="0" max="4" value="{{ old('bobot') }}" class="form-control" required>
                </div>

                <div class="form-actions">
                    <a href="{{ route('historiNilai.index') }}" class="btn-secondary">Batal</a>
