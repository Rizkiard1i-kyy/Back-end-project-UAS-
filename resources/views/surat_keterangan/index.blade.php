...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/surat_keterangan.css') }}">
</head>
<body>
...
<div class="container">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('surat_keterangan.create') }}" class="btn-primary">
        ...
        <table class="modern-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('surat_keterangan.show', $surat->no) }}" class="btn-action btn-detail">
                            Detail
                        </a>

                        @if(auth()->user()->role == 'admin')
                            <a href="{{ route('surat_keterangan.edit', $surat->no) }}" class="btn-action btn-edit">
                                Edit Status
                            </a>
                        @endif
                    </td>
