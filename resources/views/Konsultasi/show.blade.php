...
<div class="container">
    ...
    <div class="detail-card">
        <div class="detail-row">
            ...
            <span class="detail-value">{{ $konsultasi->nama_mahasiswa }} ({{ $konsultasi->nim }})</span>
        </div>
        <div class="detail-row">
            <span class="detail-label">dosen</span>
            <span class="detail-value">{{ $konsultasi->nama_dosen }}</span>
        </div>
        <div class="detail-row">
            <span class="detail-label">tanggal</span>
            <span class="detail-value">{{ $konsultasi->tanggal->format('d/m/Y') }}</span>
        </div>
        <div class="detail-row">
            <span class="detail-label">jam</span>
            <span class="detail-value">{{ $konsultasi->jam }}</span>
        </div>
        <div class="detail-row">
            <span class="detail-label">topik</span>
            <span class="detail-value">{{ $konsultasi->topik }}</span>
        </div>
        <div class="detail-row">
            <span class="detail-label">status</span>
            <span class="detail-value">{{ ucfirst($konsultasi->status) }}</span>
        </div>
        <div class="detail-row">
            <span class="detail-label">catatan</span>
            <span class="detail-value">{{ $konsultasi->catatan ?? '-' }}</span>
        </div>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('konsultasi.update', $konsultasi) }}">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-primary btn-submit">simpan keputusan</button>
            </div>
        </form>
    </div>
    @endif
